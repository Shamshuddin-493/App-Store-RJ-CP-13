    ...
    return (
      <div>
        <div>
          ...
          <ul>
            {filteredApps.map(eachResult => (
              <AppItem appDetails={eachResult} key={eachResult.appId} />
            ))}
          </ul>
        </div>
      </div>
